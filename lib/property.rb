...
class Property
  ...
  def initialize(id:, title:, description:, unavailable_dates:, 
    price_per_night:, listing_location:, user_id:)
    @id = id
    @title = title
  ...
  def self.add(listing_title, listing_description, start_date, 
    end_date, price_per_night, listing_location, user_id)
    ...
    result = @@connection.exec(
      ...
      unavailable_dates, price_per_night, 
      listing_location, user_id) 
